...
function init() {
  ...
  var mapOptions = {
    ...
    'center': (params.center ? params.center : new google.maps.LatLng(52.38389,-1.55891)),
...
layer.setMap(map);
  ...
  infowindow = new google.maps.InfoWindow({
    'size': new google.maps.Size(290, 120)
  });
...
function getAddressComponentsHtml(components) {
  ...
  for (var i = 0; i < components.length; i++) {    
    html += tr("Address", components[i].long_name);
    /*
